...
export default function InitiativesList({ initiatives, onDelete, onEdit }: Props) {
  return (<>
    { initiatives.map((i) => <InitiativeElement initiative={i} key={i.creature} onDelete={onDelete} onEdit={onEdit} />) }
  </>);
}
